...
interface AdventureActivitiesFormProps {
  initialData?: any
  isEdit?: boolean
}
...
export function AdventureActivitiesForm({ initialData, isEdit = false }: AdventureActivitiesFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.status || result.success) {
        toast({
          title: "Success",
          description: isEdit ? "Adventure activity updated successfully" : "Adventure activity added successfully",
        })
        router.push("/admin/explore-destination?tab=adventure")
      } else {
        throw new Error(result.message || "Failed to save adventure activity")
      }
    } catch (error: any) {
      toast({
        title: "Error",
        description: error.message || "Failed to save adventure activity",
        variant: "destructive",
      })
    } finally {
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g., Paragliding, Trekking, River Rafting"
                required
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Enter adventure activity description"
                rows={4}
                required
              />
            </div>
            ...
            <Button type="submit" disabled={isSubmitting}>
              {isSubmitting ? (
                ...
                <>
                  ...
                  {isEdit ? "Update Adventure Activity" : "Add Adventure Activity"}
                </>
              )}
            </Button>
          </div>
...
function PlaceDetailForm({ place, placeIndex, updatePlaceDetail, removePlace }: {
  ...
  const addAttraction = () => {
    ...
    if (editingAttractionIndex !== null) {
      ...
      toast({
        title: "Success",
        description: "Adventure location updated successfully",
      })
    } else {
      addArrayItem("topAttractions", newAttraction)
      toast({
        title: "Success",
        description: "Adventure location added successfully",
      })
    }
    ...
    <div className="space-y-6 pt-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="e.g., Chadar Trek, Goechala Trek, Bir Billing Paragliding"
          />
        </div>
        <div className="space-y-2">
      ...
      <Tabs defaultValue="attractions" className="w-full">
        <TabsList className="grid w-full grid-cols-5">
          <TabsTrigger value="attractions">Adventure Locations</TabsTrigger>
        ...
        {/* Adventure Locations (Top Attractions) */}
        <TabsContent value="attractions" className="space-y-4 mt-4">
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h5 className="font-semibold">Adventure Locations</h5>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="e.g., Chadar Trek, Goechala Trek, Bir Billing"
                  />
                </div>
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Textarea
                    ...
                    placeholder="Enter adventure location description"
                    rows={3}
                  />
                </div>
                <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              {localPlace.topAttractions.length === 0 && (
                <p className="text-sm text-muted-foreground text-center py-4">No adventure locations added yet</p>
              )}
            </div>
          </div>
        </TabsContent>
